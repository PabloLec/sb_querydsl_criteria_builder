...
import static org.example.backend.service.query.TypeHelper.castValue;
...
public class ExpressionBuilder {
    public static BooleanExpression buildExpression(PathBuilder<?> entityPath, SearchCriterion criterion) {
        ...
        Object castedValue = castValue(entityPath.getType(), criterion.getField(), criterion.getValue(), isCollection);
